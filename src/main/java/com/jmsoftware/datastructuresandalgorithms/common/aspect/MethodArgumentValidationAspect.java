package com.jmsoftware.datastructuresandalgorithms.common.aspect;
...
public class MethodArgumentValidationAspect {
     ...
     */
    @Pointcut("@annotation(com.jmsoftware.datastructuresandalgorithms.common.aspect.ValidateArgument)")
